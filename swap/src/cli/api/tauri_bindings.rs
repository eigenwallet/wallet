...
pub struct DiscoveryProgress {
    ...
    #[typeshare(serialized_as = "number")]
    pub total_succeeded_rendezvous_points: u64,
    #[typeshare(serialized_as = "number")]
    pub total_failed_rendezvous_points: u64,
    #[typeshare(serialized_as = "number")]
    pub total_quote_requests: u64,
    #[typeshare(serialized_as = "number")]
    pub total_succeeded_quote_requests: u64,
    #[typeshare(serialized_as = "number")]
    pub total_failed_quote_requests: u64,
}
...
pub enum TauriBackgroundProgress {
    ...
    Discovery(PendingCompleted<DiscoveryProgress>),
}
