...
// Discovery related types and guards
export type TauriDiscoveryProgress = Extract<TauriBackgroundProgress, { componentName: "Discovery" }>;

export function isDiscoveryProgress(
  progress: TauriBackgroundProgress,
): progress is TauriDiscoveryProgress {
  return progress.componentName === "Discovery";
}
