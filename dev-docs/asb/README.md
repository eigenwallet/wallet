...
Public Monero nodes for running the Monero Wallet RPC can be found [here](https://community.rino.io/nodes.html) and [here](https://monero.fail/?chain=monero). 
...
Public Monero mainnet nodes can be found [here]([https://moneroworld.com/#nodes](https://monero.fail/?chain=monero).
