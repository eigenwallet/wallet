...
2. The following logs (if reporting an issue):
   - Swap logs (if the issue occurred during a swap)
   - Daemon logs from your current session
   - Any error messages you received

Send your email to: help@unstoppableswap.net
